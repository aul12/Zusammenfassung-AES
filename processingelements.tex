...
\begin{figure}[H]
    \centering
    \begin{tikzpicture}
        \filldraw [draw=black,fill=white] (5,0) rectangle (3,2) 
            node[below right,max width=2cm] {\textbf{ASP}\\(Codierung)};
        \filldraw [draw=black,fill=white] (8,0) rectangle (6,2)
            node[below right,max width=2cm] {Dualband\\RAM};
        \filldraw [draw=black,fill=white] (5,3) rectangle (3,5)
            node[below right,max width=2cm] {\textbf{ISP}\\HMI\\Protokolle};
        \filldraw [draw=black,fill=white] (8,3) rectangle (6,5)
            node[below right,max width=2cm] {\textbf{ASP}\\Burstmode-Logic};
        \filldraw [draw=black,fill=white] (11,3) rectangle (9,5)
            node[below right,max width=2cm] {Radio};
        \filldraw [draw=black,fill=white] (2,5) rectangle (1,3)
            node[below right,max width=2cm,rotate=90] {Speicher};
        \filldraw [draw=black,fill=white] (2,2) rectangle (1,0)
